...
ENV PYTHONPATH "/usr/lib/python3.10/:/usr/local/lib/python3.10/dist-packages/:/work:/work/banhammer:/work/hmt-servers"
...
RUN pip3 install pipenv && pipenv install --system --deploy --pre
